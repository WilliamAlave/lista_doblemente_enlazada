...
class Nodo {
    ...
    Nodo* enlace;//puntero..
    //!nuevo enlace que apunta de atras hacia adelante
    Nodo* enlace_atras;
public:
    ...
    Nodo* getEnlace_atras()
    {
        return this->enlace_atras;
    }
    void setEnlace_atras(Nodo* enlace2)
    {
        this->enlace_atras = enlace2;
    }
    void imprimir()
    {
        cout << "/-------------------\\" << endl;
...
public:
    ...
    void InsertarAlFinal(int dato)
    {
        ...
        {
            Nodo* recorrido = this->fin->getEnlace_atras();
            while (recorrido->getEnlace_atras() != NULL)
            {
                recorrido = recorrido->getEnlace_atras();

            }
            recorrido->setEnlace_atras(temp);
        }
    }
